    ...
    function CodeineServiceFactory(Constants, $http, $rootScope) {
        ...
        var Api = {
            ...
            runCommand : function(command,nodes) {
                return $http.post(Constants.CODEINE_WEB_SERVER + getApiPrefix() + '/command-nodes', { nodes : nodes, command_info : command },{params: { project: command.project_name, redirect :false }});
            },
