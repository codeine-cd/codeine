...
public class CodeinePeerBootstrap extends AbstractCodeineBootstrap {
    ...
    protected void execute() {
        ...
        PeriodicExecuter configurationGetterExecuter = new PeriodicExecuter(
            ConfigurationGetter.INTERVAL, injector().getInstance(ConfigurationGetter.class));
    ...
    private void startMysqlSelectorThread() {
        new PeriodicExecuter(NearestMysqlHostSelectorPeer.INTERVAL,
            (Task) injector().getInstance(MysqlHostSelector.class)).runInThread();
    }
    ...
    protected void specificCreateFileServer(ContextHandlerCollection contexts) {
        ...
        addHandler(links.getNodeMonitorOutputContextPathAllProjects(),
            pathHelper.getMonitorOutputDirAllProjects(), contexts);
    }
    ...
    public int getHttpPort() {
        ...
        return (null == portString) ? 0 : Integer.valueOf(portString);
    }
