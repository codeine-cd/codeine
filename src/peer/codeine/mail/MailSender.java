...
public class MailSender
{
	...
	public void sendMailIfNeeded(boolean result, boolean previousResult, HttpCollector collector, NodeInfo node, String output, ProjectJson project)
	{
	...
	private List<String> composeMailingList(HttpCollector collector, ProjectJson project)
	{
