...
public class RawOutputServlet extends AbstractFrontEndServlet {
	...
	protected List<TemplateLink> generateNavigation(HttpServletRequest request) {
		...
		return Lists.<TemplateLink>newArrayList(new TemplateLink(projectName, UrlUtils.buildUrl(Constants.AGGREGATE_NODE_CONTEXT, ImmutableMap.of(Constants.UrlParameters.PROJECT_NAME, projectName))),new TemplateLink(resourece, "#"));
	}
